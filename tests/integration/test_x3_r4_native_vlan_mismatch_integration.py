...
def test_x0_through_x3_r4_gates_compose() -> None:
    ...
    assert manifest["topology_runtime"]["native_flow"] == "hostc_to_hostd_vlan_99"
    assert manifest["topology_runtime"]["tagged_flow_preserved"] == "hosta_to_hostb_vlan_10"
