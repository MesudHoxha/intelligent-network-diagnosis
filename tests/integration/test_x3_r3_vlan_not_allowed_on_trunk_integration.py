...
def test_x0_through_x3_r3_gates_compose() -> None:
...
def test_x3_r3_preserves_tagged_native_flow_separation() -> None:
    ...
    assert runtime["blocked_vlan"] == 10
    assert runtime["target_trunk_endpoint"] == "sw1:eth3:tagged"
    assert runtime["preserved_access_membership"] == "sw1:eth1:pvid_untagged"


def test_x3_r3_creates_no_dataset_model_or_metric_authority() -> None:
    manifest = verify_x3_r3_gate(ROOT)
