...
def test_x0_through_x3_r2_gates_compose() -> None:
...
def test_x3_r2_preserves_tagged_native_flow_separation() -> None:
    ...
    assert runtime["removed_vlan"] == 10
    assert runtime["target_memberships"] == [
        "sw1:eth1:pvid_untagged",
        "sw1:eth3:tagged",
    ]


def test_x3_r2_creates_no_dataset_model_or_metric_authority() -> None:
    manifest = verify_x3_r2_gate(ROOT)
