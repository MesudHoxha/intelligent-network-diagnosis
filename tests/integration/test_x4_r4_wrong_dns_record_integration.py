...
def test_x0_through_x4_r4_gates_compose() -> None:
    ...
    assert verify_x4_r2_gate(ROOT)["status"] == "IMPLEMENTED_RUNTIME_SLICE"
    assert verify_x4_r3_gate(ROOT)["status"] == "IMPLEMENTED_RUNTIME_SLICE"
    assert verify_x4_r4_gate(ROOT)["status"] == "IMPLEMENTED_RUNTIME_SLICE"
