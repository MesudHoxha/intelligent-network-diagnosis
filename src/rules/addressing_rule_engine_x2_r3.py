...
MISSING_DEFAULT_ROUTE_RULE_ID = "R_X2_ADDRESSING_003"
REQUIRED_FEATURES = (
...
MISSING_DEFAULT_ROUTE_SIGNATURE = {
...
def diagnose_addressing_v2(
    ...
    *,
    ...
    if not isinstance(values, Mapping):
        raise X2AddressingError("X2-R3 Feature Vector v2 has no values.")
    ...
    if unavailable:
        ...
        candidates = []
        missing_domains = []
        explanation_refs = ["conflict:x2_r3_addressing_signature_not_exact"]
