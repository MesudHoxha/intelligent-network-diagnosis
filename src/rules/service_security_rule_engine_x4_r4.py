...
D4_SIGNATURE = {"dhcp_server_reachable": True, "dhcp_lease_obtained": True, "dhcp_lease_matches_expected_scope": True, "dns_server_reachable": True, "dns_query_succeeds": True, "dns_answer_matches_expected": False, "service_process_running": True, "service_port_reachable": True, "service_flow_blocked_by_policy": False}


def diagnose_dhcp_dns_service_security_v2_r4(vector: Mapping[str, object], *, repository_root: Path = ROOT) -> dict[str, object]:
    ...
    if unavailable:
        ...
        status, prediction, candidates, refs = "abstained", None, [], ["conflict:x4_r1_r2_r3_r4_signatures_not_exact"]
