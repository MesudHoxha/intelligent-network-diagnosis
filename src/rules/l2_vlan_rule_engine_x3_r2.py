...
from src.collection.l2_vlan_state_collector_v2 import _load_object
from src.contracts.expansion import validate_diagnosis_result_v2, validate_feature_vector_v2
from src.expansion.x3_vlan_missing import X3VlanMissingError
...
def diagnose_l2_vlan_x3_r2_v2(
    ...
    *,
    ...
    if not isinstance(values, Mapping):
        raise X3VlanMissingError("X3-R2 Feature Vector v2 has no values.")
    ...
    if unavailable:
        ...
        candidates = []
        missing_domains = []
        explanation_refs = ["conflict:x3_r2_signature_not_exact"]
