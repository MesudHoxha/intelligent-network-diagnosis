...
def diagnose_dhcp_server_unavailable_v2(vector: Mapping[str, object], *, repository_root: Path = ROOT) -> dict[str, object]:
    import json
    ...
    if unavailable:
        ...
        status, prediction, candidates, refs = "abstained", None, [], ["conflict:x4_r1_signature_not_exact"]
