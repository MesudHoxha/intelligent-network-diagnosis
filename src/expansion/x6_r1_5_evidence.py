...
from src.orchestration.x6_r1_5_contract import canonical, digest, require
from src.orchestration.x6_r1_5_durable import save
...
def build_f1_artifacts(
    ...
    *,
    ...
    evidence = {
        "schema_version": 4,
        "evidence_id": "x6_r1_5_packet_loss:evidence:v4",
    ...
    vector = {
        "schema_version": 2,
        "vector_id": "x6_r1_5_packet_loss:vector:v2",
