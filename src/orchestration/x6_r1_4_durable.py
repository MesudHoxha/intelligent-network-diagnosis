"""Fsynced reservation, command intent and completion records for R1.4."""
...
from src.orchestration.x6_r1_4_contract import canonical, canonical_location, digest, load, require
...
def reservation_path(root, auth):
    return canonical_location(str(root)).parent / ".x6-r1-4-consumption" / (auth["authorization_id"] + ".json")
