...
PREDECESSOR = "ff327c10e69e0f08a5c3586e169392667fe2d893"
RELEASE = "X6_R1_5_FUTURE_F1_SUCCESSOR"
AUTHORIZATION_RELEASE = "X6_R1_5_FUTURE_F1_RUNTIME_AUTHORIZATION"
...
def identity(root=ROOT):
    ...
    paths = sorted(set(git("ls-files").splitlines()) | {
        ...
        for pattern in ("src/orchestration/x6_r1_5*.py", "src/expansion/x6_r1_5*.py", "plans/expansion/X6_R1_5*.json", "tests/fixtures/x6_r1_5_external_stub.py")
